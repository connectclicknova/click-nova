          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-600 leading-relaxed">
                Click Nova ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
                    ...
                    <li>Subscribe to our newsletter or training programs</li>
                    <li>Request information about our services</li>
                    <li>Communicate with us via email or phone</li>
                  </ul>
                  <p className="text-gray-600 leading-relaxed mt-3">
                    This information may include: name, email address, phone number, city, and service requirements.
                  </p>
                </div>
            ...
            <div className="mb-12">
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
                ...
                <li>To send you information about our services and training programs</li>
