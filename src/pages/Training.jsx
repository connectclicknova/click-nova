        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {courses.map((course, index) => {
              const colors = [
                { bg: 'bg-gradient-to-br from-blue-100 to-sky-200', text: 'text-blue-700', border: 'hover:border-blue-400' },
                { bg: 'bg-gradient-to-br from-orange-100 to-orange-200', text: 'text-orange-700', border: 'hover:border-orange-400' },
                { bg: 'bg-gradient-to-br from-cyan-100 to-cyan-200', text: 'text-cyan-600', border: 'hover:border-cyan-400' },
                { bg: 'bg-gradient-to-br from-sky-100 to-blue-200', text: 'text-sky-700', border: 'hover:border-sky-400' },
                { bg: 'bg-gradient-to-br from-indigo-100 to-indigo-200', text: 'text-indigo-700', border: 'hover:border-indigo-400' },
                { bg: 'bg-gradient-to-br from-violet-100 to-blue-200', text: 'text-violet-700', border: 'hover:border-violet-400' },
              ];
