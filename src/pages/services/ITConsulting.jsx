      ...
      <section className="bg-gray-50 py-6 sm:py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm mb-4">
            ...
            <span className="text-gray-400">â€¢</span>
            <span className="text-gray-400 uppercase">IT Consulting</span>
          </nav>
          <div className="mb-6">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-secondary mb-4">IT Consulting</h1>
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-gray-800 mb-6">Technology Solutions for Modern Businesses</h2>
            <p className="text-gray-600 text-sm sm:text-base leading-relaxed max-w-4xl mb-6">
              Navigate technology decisions with confidence. Click Nova offers IT consulting services to help you choose the right technology stack, improve IT infrastructure, and leverage technology for competitive advantage.
            </p>
